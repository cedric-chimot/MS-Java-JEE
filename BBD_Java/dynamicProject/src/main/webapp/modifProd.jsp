            ...
            <fieldset>
                ...
                <div class="container text-center">
                    ...
                    <input type="hidden" id="idArticle" name="idArticle"
                        value="<%= request.getParameter("idArticle") %>" readonly>
                    
                    <div class="form-group mt-2">
					    <label class="form-label">Image actuelle :</label>
					    <img src="<%= produitModif != null ? "images/" + produitModif.getImg() : "" %>" alt="Image actuelle du produit" width="100">
					</div>    
                    <div class="form-group mt-2">
                        <label class="form-label">Désignation :</label>
                        <!-- "disabled" rend le champ visible mais non modifiable -->
                        <input type="text" id="designation" name="designation" class="form-control"
                            size="20" value="<%= request.getAttribute("designation") %>" readonly>
                    </div>
                    <div class="form-group mt-2">
                        <label class="form-label">Prix unitaire :</label>
                        <input type="text" id="newPu" name="newPu" class="form-control" size="20"
                            value="<%= produitModif != null ? produitModif.getPu() : "" %>">
                    </div>
                    <div class="form-group mt-2">
                        <label class="form-label">Quantité :</label>
                        <input type="text" id="newQty" name="newQty" class="form-control" size="20"
                            value="<%= produitModif != null ? produitModif.getQty() : "" %>">
                    </div>
					<div class="form-group mt-2">
					    <label class="form-label">Catégorie :</label>
					    <input type="text" id="selectCat" name="selectCat" class="form-control" 
					           value="<%= request.getAttribute("selectCat") %>" readonly>
					</div>
					<div class="form-group mt-2">
